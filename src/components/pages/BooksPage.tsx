          ...
          {filteredBooks.map((book) => (
            <Dialog key={book.id}>
              <DialogTrigger asChild>
                <div className="group relative cursor-pointer rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-violet-500/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-violet-500/20 overflow-hidden">
                  {/* Book Cover */}
