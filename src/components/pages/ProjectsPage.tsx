...
const ProjectsPage: React.FC = () => {
  ...
  const projects: readonly Project[] = [
    // ⭐ Featured 1
    {
      ...
      description:
        'AI-powered productivity dashboard for focus tracking, task management, and performance analytics.',
    ...
    // ⭐ Featured 2
    {
      ...
      description:
        'Career development platform for tracking skills, projects, and professional growth.',
    ...
    // ⭐ Featured 3
    {
      ...
      title: 'CodeRush',
      description:
        'Interactive programming language training platform designed to improve coding speed and accuracy.',
    ...
    // ⭐ Featured 4
    {
      ...
      title: 'QuizForge',
      description:
        'Dynamic quiz generation platform for creating and sharing customizable quizzes.',
