...
const ContactPage: React.FC = () => {
  ...
  const mailtoFallback = () => {
    ...
    window.location.href = `mailto:eskinderkassahun25@gmail.com?subject=${subject}&body=${body}`;
  };
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <button
                  onClick={() => handleSocialClick('https://www.linkedin.com/in/eskinder-kassahun/')}
                ...
                <button
                  onClick={() => handleSocialClick('mailto:eskinderkassahun25@gmail.com')}
        ...
        <div className="mt-20 text-center">
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            <Button
              onClick={() =>
                handleSocialClick(
                  'mailto:eskinderkassahun25@gmail.com?subject=Schedule%20Call%20Request'
                )
              }
              variant="outline"
